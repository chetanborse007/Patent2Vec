...
# Source data options
SOURCE_DATASET = os.path.join(os.sep, "nobackup", "wzadrozn_patent",
                              "PatentCollection")
#SOURCE_DATASET = os.path.join(os.getcwd(), "data", "source", "Tipster")
PATENT_FIELDS = ['abstract', 'description', 'claims']
...
STANFORD_TAGGER = os.path.join(os.getcwd(), "bin", "stanford-postagger-full-2016-10-31")
STANFORD_POS_TAGGER = os.path.join(STANFORD_TAGGER, "models", "english-left3words-distsim.tagger")
STANFORD_JAR = os.path.join(STANFORD_TAGGER, "stanford-postagger.jar")
